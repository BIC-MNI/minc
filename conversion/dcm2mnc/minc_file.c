/* ----------------------------- MNI Header -----------------------------------
   ...
   @MODIFIED   : 
   * $Log: minc_file.c,v $
   * Revision 1.8  2005-05-19 15:46:14  bert
   * Fix usage of G.Name
   *
...
---------------------------------------------------------------------------- */
static const char rcsid[] = "$Header: /private-cvsroot/minc/conversion/dcm2mnc/minc_file.c,v 1.8 2005-05-19 15:46:14 bert Exp $";
