...
\subsection{miset\_spatial\_origin\_to\_start}
\begin{verbatim}
NAME 

miset_spatial_origin_to_start

SYNOPSIS

#include <minc2.h>

int  miset_spatial_origin_to_start( mihandle_t volume,
                         double     world[3])
...
\subsection{miset\_spatial\_frequency\_origin\_to\_start}
\begin{verbatim}
NAME 

miset_spatial_frequency_origin_to_start

SYNOPSIS

#include <minc2.h>

int  miset_spatial_frequency_origin_to_start( mihandle_t volume,
                                              double     world[3])
